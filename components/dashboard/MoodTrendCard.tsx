  ...
  return (
    <div className="dashboard-card">
      ...
      <div className="flex justify-center gap-3 mb-2">
        <span className={`text-2xl transition-all duration-300 ${currentMood >= 70 ? 'scale-125 opacity-100' : 'scale-75 opacity-20'}`}>😊</span>
        <span className={`text-2xl transition-all duration-300 ${currentMood >= 40 && currentMood < 70 ? 'scale-125 opacity-100' : 'scale-75 opacity-20'}`}>😐</span>
        <span className={`text-2xl transition-all duration-300 ${currentMood < 40 && history.length > 0 ? 'scale-125 opacity-100' : 'scale-75 opacity-20'}`}>😔</span>
      </div>
