...
export const Logo: React.FC<IconProps> = ({ size = 48, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
    <rect x="2" y="4" width="4" height="16" rx="2" fill="currentColor" fillOpacity="0.8" />
    <rect x="8" y="2" width="4" height="20" rx="2" fill="currentColor" fillOpacity="0.4" />
    <rect x="14" y="6" width="4" height="12" rx="2" fill="currentColor" fillOpacity="0.6" />
    <rect x="20" y="3" width="2" height="18" rx="1" fill="currentColor" fillOpacity="0.2" />
  </svg>
);

export const Home: React.FC<IconProps> = ({ size = 22, className = "" }) => (
...
export const Therapy: React.FC<IconProps> = ({ size = 22, className = "" }) => (
...
export const Stats: React.FC<IconProps> = ({ size = 22, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M3 3v18h18" /><path d="m19 9-5 5-4-4-3 3" /></svg>
);

export const User: React.FC<IconProps> = ({ size = 22, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></svg>
);

export const Activity: React.FC<IconProps> = ({ size = 22, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className={className}><polyline points="22 12 18 12 15 21 9 3 6 12 2 12" /></svg>
);

export const Mic: React.FC<IconProps> = ({ size = 22, className = "" }) => (
...
export const Moon: React.FC<IconProps> = ({ size = 20, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" /></svg>
);

export const Mail: React.FC<IconProps> = ({ size = 20, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}><rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
);
...
export const Edit: React.FC<IconProps> = ({ size = 20, className = "" }) => (
...
export const Lock: React.FC<IconProps> = ({ size = 20, className = "" }) => (
...
export const Verified: React.FC<IconProps> = ({ size = 20, className = "" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
...
export const Back: React.FC<IconProps> = ({ size = 20, className = "" }) => (
...
export const Brain: React.FC<IconProps> = ({ size = 22, className = "" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.97-2.02 2.5 2.5 0 0 1-2.02-2.97 2.5 2.5 0 0 1 .45-4.95 2.5 2.5 0 0 1 2.02-2.97 2.5 2.5 0 0 1 2.97-2.02A2.5 2.5 0 0 1 9.5 2z" /><path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.97-2.02 2.5 2.5 0 0 0 2.02-2.97 2.5 2.5 0 0 0-.45-4.95 2.5 2.5 0 0 0-2.02-2.97 2.5 2.5 0 0 0-2.97-2.02A2.5 2.5 0 0 0 14.5 2z" /></svg>
);

export const Google: React.FC<IconProps> = ({ size = 20, className = "" }) => (
