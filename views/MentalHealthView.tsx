...
const MentalHealthView: React.FC<MentalHealthViewProps> = ({ onComplete, darkMode }) => {
    ...
    return (
        <div className={`fixed inset-0 z-[100] p-8 h-screen flex flex-col resolve-ui transition-colors duration-500 ${isDark ? 'bg-black text-white' : 'bg-[#f8fdfe] text-[#1a365d]'}`}>
